...
export interface KycReverificationRequiredPayload {
  userName: string;
}

export interface KycReverificationSuccessPayload {
  userName: string;
}

export interface KycReverificationSuspendedPayload {
  userName: string;
  suspendedAt: Date;
}
...
export interface NotificationPayloadByType {
  ...
  [NotificationEventType.KYC_REVERIFICATION_REQUIRED]: KycReverificationRequiredPayload;
  [NotificationEventType.KYC_REVERIFICATION_REQUIRED_ADMIN]: KycReverificationRequiredPayload;
  [NotificationEventType.KYC_REVERIFICATION_SUCCESS]: KycReverificationSuccessPayload;
  [NotificationEventType.KYC_REVERIFICATION_SUSPENDED]: KycReverificationSuspendedPayload;
